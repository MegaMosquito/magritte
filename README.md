...
###[How to create a ".img" file, and shrink it, and compress it.](#image)

###[How to permanently mount the file system from USB media.](#mount)

###[How to format a disk for Linux use.](#format)
